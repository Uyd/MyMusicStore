    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                idManger.CreateUser(user, model.ConfirmPassWord);
                //添加到Admin角色
        ...
        public ActionResult ChangePassWord(ChangePwdViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    //判断原密码是否输入正确
                    var user = userManage.Find(userName, model.OriginalPwd);
                    ...
                    {
                        //修改密码
                        changePwdSuccessed = userManage.ChangePassword(user.Id, model.OriginalPwd, model.ConfirmNewPassWord).Succeeded;
                ...
                catch { ModelState.AddModelError("", "修改密码失败，请重试"); }
            }
            return View(model);
        }
        /// <summary>
